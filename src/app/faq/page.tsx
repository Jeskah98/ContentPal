    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="space-y-8">
        <div className="border-b pb-6">
          <h2 className="text-xl font-semibold mb-3 text-indigo-600">1. How is Content Pal AI different from other social media tools?</h2>
        ...
        <div className="border-b pb-6">
          <h2 className="text-xl font-semibold mb-3 text-indigo-600">2. How does the AI learn my brand's style?</h2>
          <p className="text-gray-700">
        ...
        <div className="border-b pb-6">
          <h2 className="text-xl font-semibold mb-3 text-indigo-600">3. Can I approve content before publishing?</h2>
          <p className="text-gray-700">
        ...
        <div className="border-b pb-6">
          <h2 className="text-xl font-semibold mb-3 text-indigo-600">4. What social platforms do you support?</h2>
          <p className="text-gray-700">
        ...
        <div className="border-b pb-6">
          <h2 className="text-xl font-semibold mb-3 text-indigo-600">5. How do you measure and improve performance?</h2>
          <p className="text-gray-700">
        ...
        <div className="border-b pb-6">
          <h2 className="text-xl font-semibold mb-3 text-indigo-600">6. Is my data secure?</h2>
          <p className="text-gray-700">
        ...
        <div className="border-b pb-6">
          <h2 className="text-xl font-semibold mb-3 text-indigo-600">7. What's the onboarding process?</h2>
          <p className="text-gray-700">
        ...
        <div className="border-b pb-6">
          <h2 className="text-xl font-semibold mb-3 text-indigo-600">8. Do you handle audience engagement?</h2>
          <p className="text-gray-700">
        ...
        <div className="border-b pb-6">
          <h2 className="text-xl font-semibold mb-3 text-indigo-600">9. What industries do you serve best?</h2>
          <p className="text-gray-700">
        ...
        <div className="pb-6">
          <h2 className="text-xl font-semibold mb-3 text-indigo-600">10. What are your pricing options?</h2>
          <p className="text-gray-700">
            We offer accessible plans starting at $295/month for growing businesses, with scalable options up to premium enterprise packages. All plans include our full AI capabilities, with differences in content volume and platform coverage. We'll help you select the perfect fit.
          </p>
        </div>
      </div>
    </div>
